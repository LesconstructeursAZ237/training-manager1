...
<body>
    ...
    <nav class="fixed w-full z-10 top-0 start-0 mb-1 opac" >
        ...
        <div class="p-4 flex justify-between flex-wrap">
            ...
            <img src="./../../../assets/img/logo2.jpg" class="h-full max-h-24 hover:bg-black rounded-lg p-1" alt=" logo"> 

            <span class="mt-8 text-justify capitalize font-serif text-white text-opacity-100 font-bold text-xl" id="texte-start1">CENTRE DE FORMATION PROFESSIONNELLE LE LEADER EN INFORMATIQUE</span>
                ...
                <ul  class="font-medium flex flex-row text-justify mt-8 justify-between overflow-x-auto ">
                    ...
                    <li class="  hover:bg-gray-200 rounded-lg  ">
                        <button> <a href="signin.php"class="text-sky-500 font-bold p-8">Connexion</a></button>
                     </li>
  ...
  <!-- ajout des images de font du debut -->
    ...
    <div class=" flex float-none items-center justify-center h-screen col-start-2 col-span-4 overflow-hidden">
        ...
        <div id="slider" class=" bg-white p-4 relative float" >
                ...
                <div class="absolute inset-0 flex text-6xl text-center top-1/2  capitalize font-serif text-white text-opacity-100">
            ...
            <div class="p-5  content-stretch md:content-around grid gap-8 sm:grid-cols-1 sm:size-10/12
             md:grid-cols-2 md:size-11/12 xl:grid-cols-3 xl:size-full 2xl:grid-cols-5 ">                              
                ...
                <div class="overflow-auto p-1 bg-white shadow-2xl rounded-md text-center">
                    <img src="./../../../assets/img/acceuil2.jpg" class="w-full h-3/4 float-left object-cover rounded-md" alt="">
                ...
                <div class="overflow-auto p-1 bg-white shadow-2xl rounded-md text-center">
                    <img src="./../../../assets/img/infographe1.jpg" class="w-full h-3/4 float-left object-cover rounded-md " alt="">
                    <h1 class="font-bold text-center">Filiere: Developpement d'application (DA)</h1>
                    <h4>Prix: 200Fcrs <br> 
                        durrée: 1 ans <br>
                        <a href="#">
